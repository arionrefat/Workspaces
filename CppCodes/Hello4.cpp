...
int main()
{
	...
	cout << "Cost: $" << (priceSmallRoom * numberOfSmallRooms) + (priceLargeRoom * numberOfLargeRooms) << "\n";
	cout << "Tax: $" << ((priceSmallRoom * numberOfSmallRooms) + (priceLargeRoom * numberOfLargeRooms)) * sales_tax << "\n";
	cout << "#################################################"
		 << "\n";

	cout << "Total estimate: $" << (priceSmallRoom * numberOfSmallRooms) + (priceLargeRoom * numberOfLargeRooms) + ((priceSmallRoom * numberOfSmallRooms) + (priceLargeRoom * numberOfLargeRooms)) * sales_tax << "\n";
