...
class QuestionBuffer {
    ...
    public synchronized String readQuestionFromReg() throws InterruptedException {
        /**
         * TODO: 1. Use monitor for this method [public synchronized String
         * readQuestionFromReg()]. 2. If the pointer is at -1, it means there is no item
         * in the list. So, suspend the StudentThread [using wait()]. 3. Take the value
         * from the the list. 4. Decrease the pointer by 1. 5. Remove the string from
         * the list, 6. Return the value
         */
        return "";
    }

    public void writeQuestionToReg(String value) {
        /**
         * TODO: 1. Use monitor for this method [public synchronized String
         * writeQuestionToReg()]. 2. Add the string to the list. 3. Increase the pointer
         * by 1. 4. If the pointer is at 0, it indicates first item in the list. So,
         * wakeup StudentThread [using notifyAll()].
         */
    }
}
...
class TeacherThread extends Thread {
    ...
    private String[] values = { "What is your name?", "What is your student ID?",
...
class StudentThread extends Thread {
    ...
    public void run() {
        try {
            while (true) {
                System.out
                        .println(Thread.currentThread().getName() + " prints: " + questionBuffer.readQuestionFromReg());
            }
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
